    ...
    return (
        <section className='grid grid-cols-1 md:grid-cols-2 gap-2 w-full ' id='home'>
            <div className='py-2 flex-1 flex flex-col items-start  justify-center gap-6'>
                ...
                <p className='text-base text-textColor text-center md:text-left md:w-[80%]'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consequatur molestias explicabo, dolorum soluta ipsa corrupti facilis architecto nihil cupiditate saepe reprehenderit? Maxime dolorem dicta fugiat dolore error temporibus architecto totam.</p>
            ...
            <div className='py-2 flex-1 flex items-center relative'>
                <img src={HeroBg} className='ml-auto h-420 w-full md:w-auto lg:h-650' alt="hero-bg" />
                ...
                <div className='w-full h-full absolute top-0 left-0 flex items-center justify-center lg:px-32 py-4 gap-4 flex-wrap'>
                    ...
                    {heropData && heropData.map(n => (
                        ...
                        <div key={n.id} className='lg:w-190 p-4 bg-cardOverlay backdrop-blur-md rounded-3xl flex flex-col items-center justify-center shadow-lg'>
                            ...
                            <p className='text-[12px] lg:text-sm text-lighttextGray font-semibold my-1 lg:my-2'>{n.desp}</p>
